...
const CreatePlaylistModal = ({photo = "", title ="Create Playlist", description= "", actionUpdate=false, playlistId}) => {
  ...
  return (
    <GeneralModal isOpen={openCreatePlaylistModal} handleClose={handleClose} title={title}>
