...
import {
  ...
  postUserPlaylistAction,
} from "../../redux/actions/userPlaylistAction";
    ...
    <form className={classes.formContainer} onSubmit={formik.handleSubmit}>
      ...
      <div className={classes.textInput}>
        <TextField
          ...
          error={
            formik.touched.playlistTitle && Boolean(formik.errors.playlistTitle)
          }
          helperText={
            formik.touched.playlistTitle && formik.errors.playlistTitle
          }
          fullWidth
          variant="outlined"
        ...
        <TextField
          ...
          error={
            ...
            Boolean(formik.errors.playlistDescription)
          }
          helperText={
            formik.touched.playlistDescription &&
        ...
        <RoundedButton
          startIcon={
            (userPlaylist.loading ||
              playlistDetail.loading ||
              user.loading) && <CircularProgress size={20} />
          } //Because it used by both saga worder userPlaylist and detail playlist
          className={classes.inputButton}
          type="submit"
          variant="primary"
        >
